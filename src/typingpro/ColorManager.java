...
public class ColorManager {
	...
	Color background, background2, background3, background4, foreground;

	List<ColorComponent> colorcomponents = new ArrayList<ColorComponent>();
	
	Color[] beach = {new Color(243, 205, 5), new Color(244, 159, 5), new Color(208, 112, 3), new Color(54, 104, 141), new Color(30,30,30)};
	
	Color[] poppies = {new Color(137,218,89), new Color(249,136,102), new Color(255,66,14), new Color(128,189,158), new Color(30,30,30)};
	
	Color[] sushi = {new Color(184,210,11), new Color(245,108,87), new Color(35,27,18), new Color(247,118,4), new Color(30,30,30)};
	
	Color[] deepsea = {new Color(196,223,230), new Color(102,165,173), new Color(7,87,91), new Color(0,59,70), new Color(30,30,30)};
	
	Color[] wood = {new Color(162,197,35), new Color(72,107,0), new Color(46,66,0), new Color(125,68,39), new Color(30,30,30)};
	
	Color[] mountain = {new Color(183,184,182), new Color(76,181,245), new Color(52,103,92), new Color(179,193,0), new Color(30,30,30)};
	
	Color[] greek = {new Color(244,234,222), new Color(237,140,114), new Color(47,73,110), new Color(41,136,188), new Color(30,30,30)};
	
	Color[] strawberry = {new Color(255,235,229), new Color(254,122,71), new Color(216,65,47), new Color(245,202,153), new Color(30,30,30)};
	
	Color[] kitchen = {new Color(253,246,246), new Color(179,219,192), new Color(254,0,0), new Color(103,186,202), new Color(30,30,30)};
	
	Color[] apples = {new Color(244,236,106), new Color(187,207,74), new Color(231,63,11), new Color(161,31,12), new Color(30,30,30)};
	...
	public void setColors(Color[] colors) {
		...
		this.background2 = colors[1];
		this.background3 = colors[2];
		this.background4 = colors[3];
		this.foreground = colors[4];
	...
	// ProgressBar
		...
		registerComponent(frame.progress,4,1);
